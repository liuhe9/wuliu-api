...
class Logistics extends Model
{
    ...
    protected $fillable = ['tracking_no', 'consigner_id', 'receiver_name', 'receiver_mobile', 'product_desc', 'note', 'images', 'finish_images', 'from_address', 'from_gps', 'to_address', 'to_gps'];
